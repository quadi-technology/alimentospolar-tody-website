...
/* Edit Messages to Form Validate*/
function dhvc_form_custom_validate_messages(){
    return array(
                'required'=>__("campo requerido.",DHVC_FORM),
                'remote'=>__("por favor corrija los datos ingresados",DHVC_FORM),
                'email'=>__("por favor ingrese un mail válido",DHVC_FORM),
                'url'=>__("por favor ingresa una url válida",DHVC_FORM),
                'date'=>__("por favor ingrese una fecha",DHVC_FORM),
                'dateISO'=>__("Please enter a valid date (ISO).",DHVC_FORM),
                'number'=>__(" por favor ingrese un número valid",DHVC_FORM),
				'number2'=>__("por favor solo use números o ñ",DHVC_FORM),
				'dhvcformunique'=>__("Correo ya existente",DHVC_FORM), 
				'dhvcformuniquewithstatus'=>__("Correo ya existente ",DHVC_FORM),
                'digits'=>__("por favor solo digitos números ",DHVC_FORM),
                'creditcard'=>__("Please enter a valid credit card number.",DHVC_FORM),
                'equalTo'=>__("Ingrese de nuevo la información",DHVC_FORM),
                'maxlength'=>__("debe ingresar al menos 3 números",DHVC_FORM),
                'minlength'=>__("debe ingresar al menos 3 letras",DHVC_FORM),
                'rangelength'=>__("por favor ingrese un número con minimo 3 numero maxim 10",DHVC_FORM),
                ...
                'alpha'=>__('por favor ingrese solo letras',DHVC_FORM),
                'alphanum'=>__('por favor ingrese solo letras',DHVC_FORM),
                ...
                'fax'=>__('por favor ingress un numero valido, como (123) 456-7890 or 123-456-7890.',DHVC_FORM),
                'cpassword'=>__('Please make sure your passwords match.',DHVC_FORM),
                'select'=>__('por favor seleccione una opción',DHVC_FORM),
                'recaptcha'=>__('Please enter captcha words correctly',DHVC_FORM),
                'captcha'=>__('Please enter captcha words correctly',DHVC_FORM),
                'extension'=>__('por favor ingrese una extension valida.',DHVC_FORM)
            );
}
