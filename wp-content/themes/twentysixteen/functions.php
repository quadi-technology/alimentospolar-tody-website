...
function dhvc_form_custom_validate_messages(){
    return array(
                'required'=>__("This field is requerido.",DHVC_FORM),
				...
				'number2'=>__("Please use only numbers (0-9) or brackets (), dashes – and plus +",DHVC_FORM),
				'dhvcformunique'=>__("Value must me be unique.",DHVC_FORM), 
				'dhvcformuniquewithstatus'=>__("Value must me be unique.",DHVC_FORM),
