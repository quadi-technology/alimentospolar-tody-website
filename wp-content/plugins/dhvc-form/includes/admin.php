...
class DHVCFormAdmin {
	...
	public function init(){
		...
		$this->meta_boxs = array(
				...
				array (
					'type' => 'select',
					'label' => __ ( 'Recipients Email Type', 'dhvc-form' ),
					'name' => 'recipients_email_type',
					'value'=>'recipients_email_text',
					'options'=>array(
						'email_text'=>__ ( 'Email', 'dhvc-form' ),
						'email_field'=>__ ( 'Email Field', 'dhvc-form' ),
					),
				...
				array (
					'type' => 'select_recipient',
					'label' => __ ( 'Recipients Field', 'dhvc-form' ),
					'name' => 'notice_recipients_variables',
					"description"=>__('The form must have at least one Email Address element to use this feature.','dhvc-form')
				),
