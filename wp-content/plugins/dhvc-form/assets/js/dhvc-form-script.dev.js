...
!function( $ ) {
	...
	$(document).ready(function () {
		...
		$.extend($.validator.messages, {
			...
			dhvcformunique: dhvcformL10n.validate_messages.dhvcformunique,
			dhvcformuniquewithstatus:dhvcformL10n.validate_messages.dhvcformuniquewithstatus,
		...
		$.validator.addMethod("dhvcformunique", function(value, element, param) {
				var isUniqueValid = true;
			if(dhvcformL10n.unique_ajax_verify==='yes' ){
				isUniqueValid = false
				$.ajax({
			...
			return isUniqueValid;
		},dhvcformL10n.validate_messages.dhvcformunique);
		$.validator.addMethod("dhvcformuniquewithstatus", function(value, element, param) {
				var isUniquewithstatusValid = true;
			if(dhvcformL10n.unique_ajax_verify==='yes' ){
				isUniquewithstatusValid = false
				$.ajax({
				    url: dhvcformL10n.ajax_url,
				    type: "POST",
				    async: false,
			...
			return isUniqueValid;
		},dhvcformL10n.validate_messages.dhvcformuniquewithstatus);
