...
<div id="gwa-gopf-admin-wrap" class="wrap">
	...
	<form id="gwa-gopf-settings-form" name="gwa-gopf-settings-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>&noheader=true">
		...
		<!-- postbox -->
		<div class="postbox">
			<h3 class="hndle"><?php _e( 'Social Media', 'go_portfolio_textdomain' ); ?><span class="gwwpa-toggle"></span></h3>
			<div class="inside">
				<table class="form-table">
		        	
		        	<tr valign="top">
						<th scope="row">Social Media</th>
						<td><label for="showsocial"><input name="showsocial" type="checkbox" id="showsocial" value="1" <?php echo $general_settings['showsocial'] ? "checked": ""; ?> /> Enable social media</label>
						<p><label for="showfacebook"><input name="showfacebook" type="checkbox" id="showfacebook" value="1" <?php echo $general_settings['showfacebook'] ? "checked": ""; ?> /> Show Facebook button</label>
						<br><label for="showtwitter"><input name="showtwitter" type="checkbox" id="showtwitter" value="1" <?php echo $general_settings['showtwitter'] ? "checked": ""; ?> /> Show Twitter button</label>
						<br><label for="showdownload"><input name="showdownload" type="checkbox" id="showdownload" value="1" <?php echo $general_settings['showdownload'] ? "checked": ""; ?> /> Show Download button</label>
						</td>
					</tr>
		        	<tr valign="top">
						<th scope="row">Buttons direction and Position</th>
						<td>
						Position CSS: <input name="socialposition" type="text" id="socialposition" value="<?php echo esc_html($general_settings['socialposition']); ?>" class="regular-text" />
						<p>Position CSS on small screen: <input name="socialpositionsmallscreen" type="text" id="socialpositionsmallscreen" value="<?php echo esc_html($general_settings['socialpositionsmallscreen']); ?>" class="regular-text" /></p>
						<select name="socialdirection" id="socialdirection">
						  <option value="horizontal" <?php echo ($general_settings['socialdirection'] == 'horizontal') ? 'selected="selected"' : ''; ?>>horizontal</option>
						  <option value="vertical" <?php echo ($general_settings['socialdirection'] == 'vertical') ? 'selected="selected"' : ''; ?>>vertical</option>
						</select>
						</p>
						<p><label for="socialrotateeffect"><input name="socialrotateeffect" type="checkbox" id="socialrotateeffect" value="1" <?php echo $general_settings['socialrotateeffect'] ? "checked": ""; ?> /> Enable button rotating effect on mouse hover</label></p>	
						</td>
					</tr>
